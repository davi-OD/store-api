...
class ProductSerializer(serializers.ModelSerializer):
    ...
    sale_start = serializers.DateTimeField(
        ...
        help_text='Accepted format is "12:01 PM 16 Febuary 2024"',
        style={'input_text': 'text', 'placeholder': '12:01 AM 28 June 2024'},
    )
    ...
    # This method is in the serializer subclass and is overiden and used to add extra data to the serialized response
    # This has been refactored to the lines 6 and 7
...
# Serializer usong composite fields
